...
<body>
    <div class="navbar">
        ...
        <div class="login">
            <?php if (isset($_SESSION['username'])): ?>
                <a href="logout.php">
                    <img src="assets/logo-logout.png" alt="" class="logo-login">
                </a>
            <?php else: ?>
                <a href="login.php">
                    <img src="assets/logo-login.png" alt="" class="logo-login">
                </a>
            <?php endif; ?>
        </div>
    ...
    <div class="container">      
        ...
        <section id="searchMenu">
            <input type="text" id="searchInput" placeholder="Cari menu makanan..." onkeyup="searchMenu()">
        </section>
        <!-- Menu Section -->
        <section id="menu">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if ($row["file_name"]) {
                                        echo "<td><a href='uploads/" . $row["file_name"] . "'>Download File</a></td>";
                                    } else {
                                        echo "<td>No file</td>";
                                    }
        ...
        <div class="popup" id="popupBox">
            <div class="popup-content">
                ...
                <form id="orderForm" method="POST" action="upload_order.php" enctype="multipart/form-data">
                    <input type="hidden" id="orderId" name="id">
                    <label for="name">Nama:</label>
                    <input type="text" id="name" name="name" required><br><br>

                    <input type="hidden" id="menuItem" name="menuItem"> <!-- Hidden field for menu item -->
                    ...
                    <label for="fileToUpload">Upload File (optional):</label>
